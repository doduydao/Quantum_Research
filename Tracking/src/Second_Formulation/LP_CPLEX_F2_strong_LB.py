...
if __name__ == '__main__':
    ...
    data_path = src_path + '/20hits/know_track/hits.csv'
    hits_volume = read_hits(data_path)
    hits = hits_volume[9]

    model_path_out = "results/20hits/know_track/model_docplex_strong_LB.lp"
    solution_path_out = "results/20hits/know_track/solution.json"
    figure_path_out = "results/20hits/know_track/result.PNG"
